...
object BeansGenerator : KLogging() {
    ...
    private fun getControllersToValidate(): Set<Class<*>> {
        val controllers =
            ClassesUtil.getAnnotatedClassesIn(JsonValidationConfig.controllersPackageName, Controller::class.java)
        val restControllers =
            ClassesUtil.getAnnotatedClassesIn(JsonValidationConfig.controllersPackageName, RestController::class.java)
